...
//		List<Board> result = new AdminService().searchBoard(searchType,keyword,cPage,numPerPage);
//		
//		request.setAttribute("list", result);
//		request.getRequestDispatcher("/views/admin/boardList.jsp") //.....,... ㅇ...ㅇㄹ,ㅡ나ㅣㅗㅓ존나 짜증 "/"...
